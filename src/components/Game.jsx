			...
			{endgame && (
				<div className="Gameovercont z-20 absolute flex justify-center items-center">
					...
					<div className="w-3/4 h-max p-24 pt-32 rounded relative">
						...
						<p className="downhere text-4xl text-score">
							Score: {level}
						</p>
						{isLoggedin && (
							<p className="prevscore">
								Your Highest: {currentUserHighscore}
							</p>
						)}
				...
				<div className="w-screen h-screen flex flex-col justify-center items-center z-10 absolute">
					...
					<div className="w-screen h-3/5 flex flex-col justify-center items-center">
						...
						<div className="absolute left-20 w-56 rotate-24 bottom-56 flex flex-col">
							<p className="jah text-2xl text-white">
								How To Play
							</p>
							<p className="jah text-1xl text-white">
								Pick the colour that doesn’t match the rest!!!!
